    ...
    return (
        <ContextMenu>
            <ContextMenuTrigger asChild>
                <div className="flex items-center justify-between p-4 bg-secondary rounded-md shadow-sm ease-in-out transition-colors duration-200 cursor-pointer hover:bg-sidebar">
                    <div id="info">
